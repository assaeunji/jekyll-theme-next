...
* 제목은 "어디까지 파봤니"로 약간 거만하지만 사실은 많이 안 파봤고, 저도 평소에 궁금했던 증명 과정과 헷갈렸던 내용들 위주로 정리해보았습니다. 언제나 그랬듯, 파이썬 예시와 함께 합니다.
...
y_t - (\phi_1 Ly_t +\lodts L^p \phi_p y_t) &= \epsilon_t + (\theta_1 L\epsilon_t + \cdots + \theta_q L^q \epsilon_t)\\
