...
* [파이썬 머신러닝 완벽 가이드](http://www.yes24.com/Product/Goods/69752484) 책을 참고해 정리하였습니다.
* 실습에 대한 전체 코드는 [이 곳](https://github.com/assaeunji/tree-based-analysis/blob/main/XGBoost-Santander.ipynb)에서 확인하실 수 있습니다.
----
## Introduction 
...
자세한 설명은 [lightGBM / XGBoost 파라미터 설명](http://machinelearningkorea.com/2019/09/29/lightgbm-파라미터/)을 참조해주시길 바랍니다.
...
마찬가지로, 중요도 순으로 정렬하였고 자세한 내용은 [lightGBM / XGBoost 파라미터 설명](http://machinelearningkorea.com/2019/09/29/lightgbm-파라미터/)을 참조해주시길 바랍니다.
...
이번에는 캐글의 [산탄데르 고객 만족 데이터 세트](https://www.kaggle.com/c/santander-customer-satisfaction)에 대해서 고객 만족 여부를 XGBoost와 LightGBM을 통해 예측해보겠습니다.
...
## References
* [lightGBM / XGBoost 파라미터 설명](http://machinelearningkorea.com/2019/09/29/lightgbm-파라미터/)
* [산탄데르 고객 만족 데이터 세트](https://www.kaggle.com/c/santander-customer-satisfaction)
