...
$$
\operatorname{BICscore}(\mathcal{G}, \mathcal{D})=\lo\mathcal{G} \operatorname{Pr}(\mathcal{D} \vert G)-\frac{d}{2} \log N
$$

여기서 $\log \operatorname{Pr}(\mathcal{D} \vert G)$는 $\mathcal{G}$의 인과 구조를 가졌을 때의 로그 가능도이고 $d$는 free parameter의 개수입니다. 
...
![](../../images/dental-pairs.png){: width="250", height="250"}

![](../../images/dental-cor.png){: width="250", height="250"}
